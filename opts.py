...
def parse_opts():
    ...
    parser.add_argument('--n_frames_path', default='n_frames.txt', type=str, help='Path to file containing number of frames for each video')
    parser.add_argument('--dataset', default='kinetics', type=str, help='Used dataset (activitynet | kinetics | mini-kinetics | ucf101 | hmdb51)')
    parser.add_argument('--n_classes', default=400, type=int, help='Number of classes (activitynet: 200, kinetics: 400, mini-kinetics: 200, ucf101: 101, hmdb51: 51)')
    ...
    parser.add_argument('--batch_split', default=1, type=int, help='How many splits the batch should be divided to so that each split can fit into memory')
    ...
    parser.add_argument('--separable_conv', action='store_true', help='Separate 3D convolution into first spatial and then temporal 2D convolution')
    parser.set_defaults(separable_conv=False)
